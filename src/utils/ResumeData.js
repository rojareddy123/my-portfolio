...
export const  WORK_EXPERIENCE = [
  {
    ...
    'Built RESTful API’s using (JAVA)Spring Boot  which are then consumed by the front-end application to serve the business needs.Worked on various projects and developed Responsive Dashboards using Object Oriented Programming which uses HTML, CSS, JavaScript, ES6, Vue.js, React.js.',
